...
| Club Context evidence gate, attention volume, round cutoff, both shadow evaluators, reader safety, and the default-off value guard | [source](club-context.mmd) | [preview](club-context.svg) |
